...
public class StrategicProjectByStatusDto {
    ...
    public StrategicProjectByStatusDto(){}

    public StrategicProjectByStatusDto(int portfolioId, String nomePortfolio, int areaId, String nomeArea,
            int programaId, String nomePrograma, int projetoId, String nomeProjeto, int orgaoId, String nomeOrgao,
            int statusId, String nomeStatus, String corStatus) {
