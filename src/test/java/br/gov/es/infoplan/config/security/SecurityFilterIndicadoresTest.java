...
class SecurityFilterIndicadoresTest {
    ...
    @CsvSource({
            ...
            "/capitation/test, PAINEL_EXEC_ORC_IND_DPES, 401"
    })
    void verificaPermissaoPorModulo(String uri, String role, int status) throws Exception {
        ...
        when(tokens.getSiglaFromToken("token")).thenReturn("DPES");
